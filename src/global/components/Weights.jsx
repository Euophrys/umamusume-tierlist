...
class Weights extends React.Component {
    ...
    render() {
        const resetScenarios = [
            ...
            { id: 'reset-weights-MANT', label: 'TB', handler: () => this.onMANTReset() },
            { id: 'reset-weights-URA', label: 'Unity', handler: () => this.onAoharuReset() },
            ...
            <div className="weights font-sans text-left">
                ...
                <div className="grid grid-cols-6 gap-1.5 mb-5">
                    {['speed', 'stamina', 'power', 'guts', 'wisdom', 'friend'].map((type, idx) => {
                        ...
                        const label = type === 'wisdom' ? 'Wit' : type.charAt(0).toUpperCase() + type.slice(1);
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-3.5 border border-slate-200 dark:border-zinc-850 rounded-xl space-y-3">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div className="flex flex-col space-y-1">
                                        <span className="text-[10px] text-slate-500 dark:text-zinc-400 uppercase font-semibold text-center">G1</span>
                                        <NumericInput onChange={this.onGeneralSettingChanged} id="races.0" value={this.state.general.races[0]} min={0} max={30} step={1}/>
                                    </div>
                                    <div className="flex flex-col space-y-1">
                                        <span className="text-[10px] text-slate-500 dark:text-zinc-400 uppercase font-semibold text-center">G2/G3</span>
                                        <NumericInput onChange={this.onGeneralSettingChanged} id="races.1" value={this.state.general.races[1]} min={0} max={30} step={1}/>
                                    </div>
                                    <div className="flex flex-col space-y-1">
                                        <span className="text-[10px] text-slate-500 dark:text-zinc-400 uppercase font-semibold text-center">OP</span>
                            ...
                            <div className="p-3.5 border border-slate-200 dark:border-zinc-850 rounded-xl space-y-3">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    ...
                                    <div className="flex flex-col space-y-1">
                                        <span className="text-[10px] text-slate-500 dark:text-zinc-400 uppercase font-semibold">Wit</span>
                            ...
                            <div className="p-3.5 border border-slate-200 dark:border-zinc-850 rounded-xl space-y-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center text-xs">
                                        <span className="font-bold uppercase tracking-wider text-slate-600 dark:text-zinc-400">Mood Effect</span>
                ...
                <div className="mt-5 pt-4 border-t border-slate-100 dark:border-zinc-800">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                        ...
                        <div className="flex flex-col space-y-1">
                            <span className="text-[10px] text-slate-500 dark:text-zinc-400 uppercase font-semibold text-center">Wit</span>
