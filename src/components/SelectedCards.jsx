      ...
      <div className="mt-6 pt-4 border-t border-slate-100 dark:border-zinc-800">
        ...
        <div className="flex flex-wrap gap-1.5">
          <button
            ...
            onClick={() =>
              props.onLoadPreset([20023, 20033, 20009, 20003, 30137])
            }
          >
            Speed/Power
          </button>
          <button
            className="px-3 py-1 border border-slate-200 dark:border-zinc-800 rounded-full text-xs font-semibold bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            onClick={() =>
              props.onLoadPreset([20023, 20033, 20008, 30022, 30137])
            }
          >
            Speed/Stamina
          </button>
          <button
            className="px-3 py-1 border border-slate-200 dark:border-zinc-800 rounded-full text-xs font-semibold bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            onClick={() =>
              props.onLoadPreset([20023, 20033, 20012, 20002, 30137])
            }
          >
            Speed/Int
          </button>
          <button
            className="px-3 py-1 border border-slate-200 dark:border-zinc-800 rounded-full text-xs font-semibold bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            onClick={() =>
              props.onLoadPreset([30028, 20048, 20041, 20012, 20002])
            }
          >
            Guts/Int
          </button>
          <button
            className="px-3 py-1 border border-slate-200 dark:border-zinc-800 rounded-full text-xs font-semibold bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            onClick={() =>
              props.onLoadPreset([20012, 20016, 20025, 20002, 10060])
            }
          >
            Aoharu Parent
          </button>
          <button
            className="px-3 py-1 border border-slate-200 dark:border-zinc-800 rounded-full text-xs font-semibold bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            onClick={() =>
              props.onLoadPreset([30028, 20008, 20009, 30019, 20012])
            }
          >
            Highlander
          </button>
          <button
            className="px-3 py-1 border border-slate-200 dark:border-zinc-800 rounded-full text-xs font-semibold bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            onClick={() =>
              props.onLoadPreset([20031, 30074, 20027, 20012, 30054])
            }
          >
            Race Bonus
          </button>
